      ...
      if isBinary:
         ...
         # if in streaming 
            ...
            # regular hypothesis
               ...
               hypothesis = jsonObject['results'][0]['alternatives'][0]['timestamps']
               ...
               if bFinal:
                  ...
                  f.close()
                  print("226")
                  self.summary[self.uttNumber]['hypothesis'] += str(hypothesis)
                  print("227")
               else:
...
if __name__ == '__main__':
   ...
   parser.add_argument('-in', action='store', dest='fileInput', default='speech-to-text-websockets-python/recordings.txt', help='text file containing audio files')
   parser.add_argument('-out', action='store', dest='dirOutput', default='speech-to-text-websockets-python/output', help='output directory')
